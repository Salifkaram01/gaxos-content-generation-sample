...
{
    public class MeshyTextToVoxelRequestedItem : VisualElementComponent, IRequestedItem
    {
        public new class UxmlFactory : UxmlFactory<MeshyTextToVoxelRequestedItem, UxmlTraits>
        {
        }
        ...
        public MeshyTextToVoxelRequestedItem()
        {
        ...
        public async Task Save(Request request)
        {
            ...
            var model = await MeshyModelHelper.DownloadFileAsync(
                request.GeneratorResult["result"]!["model_urls"]!["glb"]!.ToObject<string>());
